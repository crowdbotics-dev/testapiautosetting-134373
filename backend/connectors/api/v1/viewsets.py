...
class Testconnectors134373ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS134373_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS134373_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS134373"
